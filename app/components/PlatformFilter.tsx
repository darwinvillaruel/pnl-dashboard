...
const options: Platform[] = ["All", "Facebook", "TikTok"];

export default function PlatformFilter({ selected, onChange, counts }: PlatformFilterProps) {
  return (
        ...
        >
          ...
          <span
            className={`rounded-full px-1.5 py-0.5 text-xs ${
              selected === opt ? "bg-blue-500/30 text-blue-100" : "bg-slate-700 text-slate-400"
            }`}
          >
            {counts[opt]}
          </span>
